...
public sealed class ProveedorRepository(string cs):IProveedorRepository
{
 ...
 private static Proveedor Map(SqlDataReader r)=>new(){ProveedorID=r.GetInt32(r.GetOrdinal("ProveedorID")),CompaniaNombre=r.GetString(r.GetOrdinal("CompaniaNombre")),NombreContacto=Text(r,"NombreContacto"),CargoContacto=Text(r,"CargoContacto"),Direccion=Text(r,"Direccion"),Ciudad=Text(r,"Ciudad"),CodigoPostal=Text(r,"CodigoPostal"),Pais=Text(r,"Pais"),Telefono=Text(r,"Telefono"),Fax=Text(r,"Fax")};
}
